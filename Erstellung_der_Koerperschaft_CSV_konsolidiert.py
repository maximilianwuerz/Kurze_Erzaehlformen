...
buch_df = pd.read_csv(
    r'C:\Users\ab32ihaq\FAUbox\Dissertation\FAU\Dissertation\Arbeitspakete\4_Feldanalyse\Relationale Datenbank\20250515\2008-2023_Buch_konsolidiert.csv',
    sep=';', encoding='utf-8'
)

# 3. Schritt: Einlesen der aktuellen Literaturwettbewerb.csv
literaturwettbewerb_df = pd.read_csv(
    r'C:\Users\ab32ihaq\FAUbox\Dissertation\FAU\Dissertation\Arbeitspakete\4_Feldanalyse\Relationale Datenbank\20250515\Literaturwettbewerb_konsolidiert.csv',
    sep=';', encoding='utf-8'
)

# 4. Schritt: Einlesen der Literaturzeitschrift.csv
literaturzeitschrift_df = pd.read_csv(
    r'C:\Users\ab32ihaq\FAUbox\Dissertation\FAU\Dissertation\Arbeitspakete\4_Feldanalyse\Relationale Datenbank\20250515\Literaturzeitschrift_konsolidiert.csv',
    sep=';', encoding='utf-8'
)

# 5. Schritt: Einlesen der Plattform_Internet.csv
plattform_internet_df = pd.read_csv(
    r'C:\Users\ab32ihaq\FAUbox\Dissertation\FAU\Dissertation\Arbeitspakete\4_Feldanalyse\Relationale Datenbank\20250515\Plattform_Internet_konsolidiert.csv',
    sep=';', encoding='utf-8'
)
...
koerperschaft_df.to_csv(
    r'C:\Users\ab32ihaq\FAUbox\Dissertation\FAU\Dissertation\Arbeitspakete\4_Feldanalyse\Relationale Datenbank\20250515\db_upload\Koerperschaft_konsolidiert.csv',
